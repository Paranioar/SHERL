...
def get_argument_parser():
    ...
    parser.add_argument('--bert_lr_factor', default=0.1, type=float,
                        help='The lr factor for fine-tuning the bert or adapter')
    parser.add_argument('--input_scale_factor', type=float, default=1,
                        help='The factor for scaling the input image')
    parser.add_argument('--decay_factor', default=1e-4, type=float,
                        help='The factor of weight decay for the optimizer')

    # --------------------- adapter arguments ------------------------ #
    parser.add_argument('--downsample_factor', default=2, type=int,
                        help='Step of hidden-size-based pooling (according to final feature output)')

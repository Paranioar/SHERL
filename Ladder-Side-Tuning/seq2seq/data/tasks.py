...
class AbstractTask(abc.ABC):
    ...
    def load_dataset(self, split: int):
        return datasets.load_dataset(self.name, self.config, split=split, script_version="master", download_config=download_config)
...
class Squad(AbstractTask):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset(self.name, split=split, script_version="master", download_config=download_config)
...
class MRPC(AbstractTask):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset('glue', 'mrpc', split=split, script_version="master", download_config=download_config)
...
class COLA(AbstractTask):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset('glue', 'cola', split=split, script_version="master", download_config=download_config) 
...
class SST2(AbstractTask):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset('glue', 'sst2', split=split, script_version="master", download_config=download_config)
...
class STSB(AbstractTask):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset('glue', 'stsb', split=split, script_version="master", download_config=download_config)
...
class QQP(AbstractTask):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset('glue', 'qqp', split=split, script_version="master", download_config=download_config)
...
class MNLI(AbstractTask):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset('glue', 'mnli', split=split, script_version="master", download_config=download_config)
...
class QNLI(AbstractTask):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset('glue', 'qnli', split=split, script_version="master", download_config=download_config)
...
class RTE(AbstractTask):
    ...
    def load_dataset(self, split):
        return datasets.load_dataset('glue', 'rte', split=split, script_version="master", download_config=download_config)

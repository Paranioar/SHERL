...
class TrainingArguments(Seq2SeqTrainingArguments):
    ...
    weight_decay: Optional[float] = field(default=0.0, metadata={"help": "Defines the value for weight decay."})
    lr_factor: Optional[float] = field(default=1.0, metadata={"help": "Defines the value for lr factor."})

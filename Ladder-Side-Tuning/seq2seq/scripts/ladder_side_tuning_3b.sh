...
encoder_side_layers="[22,23]"

rm -r outputs/${output_name}

python scripts/update_scripts_for_given_input.py configs/${config_name}.json model_name_or_path str t5-3b
python scripts/update_scripts_for_given_input.py configs/${config_name}.json tokenizer_name str t5-3b
...
cp outputs/${output_name}/all_results.json  all_output_logs/t5-3b:${output_name}_bias_r${r}_lr${lr}_$2@$4.json